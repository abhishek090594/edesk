 ...
 * @author SOHIL
 */
public class phDeleteStudentInquiryData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           int res = saifdm.studDeleteInfo(delid);
          if(res != 0)
            {
            ...
            else 
            {
              ...
              request.setAttribute("err","Record not Deleted" + res);
                ...
                out.println("Error in StfEditInquiryFormDetailController :"+ e);
        }
