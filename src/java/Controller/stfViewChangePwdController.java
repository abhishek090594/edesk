...
public class stfViewChangePwdController extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           HttpSession sobj = request.getSession(false);
            if(sobj != null)
            {
                ...
                {
                    id=sobj.getAttribute("Stf_is_logged_in").toString();
                }
            }
            request.setAttribute("data", id);  
           robj = request.getRequestDispatcher("View/changePwd.jsp");
