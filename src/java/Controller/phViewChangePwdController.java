...
public class phViewChangePwdController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  
        {
            ...
            if(sobj != null)
            {
                ...
                {
                    id=sobj.getAttribute("ph_is_logged_in").toString();
                }
            }
           request.setAttribute("data", id);  
           robj = request.getRequestDispatcher("View/panelHead/changePwd.jsp");
