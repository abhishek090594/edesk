 ...
 * @author SOHIL
 */
public class phAddInquiryFormDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      response.setContentType("text/html;charset=UTF-8");
        ...
        try {
           ...
           status = Integer.parseInt(request.getParameter("drpdwnstatusdrpdwnstatus"));
            ...
            String ph_id = String.valueOf(sobj.getAttribute("ph_id_is_logged_in"));
            ResultSet rs = saifm.getStaffId(Integer.parseInt(ph_id));
            int i = 0;
            while (rs.next()) {
                i =  rs.getInt("stf_id");
            ...
            ResultSet rs1 = saifm.checkEmailExist();
            if(rs1.next())
            {
      ...
      //            out.println(res);
            if(res != 0)
            {
                ...
                request.setAttribute("path","/phViewInquiryFormController");
                ...
                request.setAttribute("msg","Record inserted successfully");
                 robj = request.getRequestDispatcher("/phViewInquiryFormController");
                robj.forward(request, response);
                }
            ...
            else 
            {
                ...
                out.println("Error in phAddInquiryFormController :"+ e);
        }        }
