 ...
 * @author SOHIL
 */
public class phUpdateStudentDetailController extends HttpServlet {
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        if(res != 0)
              ...
              if(status == 1)
                {
                    ...
                    request.setAttribute("path","/phStudentListController");
                ...
                request.setAttribute("msg","Record Updated successfully");
                 robj = request.getRequestDispatcher("/phStudentListController");
                robj.forward(request, response);
                }
            }
            else 
            {
                ...
                out.println("Error in phUpdateStudentDetailController :"+ e);
        }
    }
