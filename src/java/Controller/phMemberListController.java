 ...
 * @author SOHIL
 */
public class phMemberListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession sobj = request.getSession(false);
            ...
            ResultSet rs=  dvsm.getListForPanelHeadMembers(Integer.parseInt(s));
            request.setAttribute("getPanelMemberList",rs);
            RequestDispatcher objRD = request.getRequestDispatcher("View/panelHead/staff_list.jsp");
