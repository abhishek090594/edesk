...
function hi(meth,g_id,i_id)
{
	//alert(meth+g_id+'/'+i_id);
	del=meth+'/'+g_id+'/'+i_id;
	//alert(del);
	$('ul.gallery li').hover(function () {
        ...
        $(this).append('<div class="well gallery-controls">' +
            '<p> <a href="'+del+'" class="gallery-delete btn" onclick="return confirm('+"'Are you Sure?'"+');"><i class="glyphicon glyphicon-remove"></i></a></p>' +
            '</div>');
