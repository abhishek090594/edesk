...
<div class="box-content alerts">
    ...
    <div class="box-content">
    	<form method="post" action="">			
            ...
            <tbody>				
							   <%                                             
                                                          ResultSet rs= (ResultSet)request.getAttribute("getPanelMembers");
                                                   ...
                                                   */    
                                                          while(rs.next())
                                                           { %>
                                                              ...
                                                              <%= rs.getString("s.stf_name") %>
                                                              </td><td> 
                                                              
                                                                  <a href="<%= request.getContextPath() %>/DirDeleteMemberFromPanel?delsid=<%= rs.getInt("s.stf_id") %>"><img src="<%= request.getContextPath() %>/assets/images/delete.gif"</a>
