<%--
    Document   : index
    Created on : Mar 10, 2016, 10:57:34 PM
    Author     : SOHIL
--%>
...
<img src="<%= request.getContextPath() %>/StaffColumnChartServlet" title="Admission Confirmation Details using Column Chart" style="margin: -185px;">	
