			...
			<div class="cl">&nbsp;</div>
				...
				<div class="box">
					...
					<div class="table">
                                                   ...
                                                   */     while(rs.next())
                                                           {
                                                              ...
                                                              out.println("</td><td>"); 
                                                              if(Integer.parseInt(rs.getString("stud_status")) == 0)
                                                              {
                                                              out.println("Come For Inquiry");                                                                            
                                                              
                                                              }
                                                              
                                                              if(Integer.parseInt(rs.getString("stud_status")) == 1)
                                                              {
                      ...
                      out.println("<a onclick=return CONFIRM('Are you sure you want to delete?')  href="+ request.getContextPath() +"/phDeleteStudentInquiryData?did="+ rs.getInt("stud_id") +" class='ico del'>Delete</a><a href="+ request.getContextPath() +"/phEditInquiryFormDetailController?edtid="+ rs.getInt("stud_id") +" class='ico edit'>Edit</a><a href='#' class='ico view'>View</a>");
