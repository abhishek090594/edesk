...
<script type="text/javascript">
                ...
                function validate()
                {
                    var opwd = frm1.txtoldpwd.value;
                    var pwd = frm1.txtnewpwd.value;
                    var cpwd = frm1.txtcpwd.value;
                        if(!opwd.trim())
                    {
                        alert("Current Password is mandatory");
                        frm1.txtoldpwd.focus();
                        return false;
                    }
                       if(!pwd.trim())
                    {
                        alert("New is mandatory");
                        frm1.txtnewpwd.focus();
                        return false;
                    }
                     if(!cpwd.trim())
                    {
				...
				<div class="box">
					<div class="box-head">
						<h2>Change Password</h2>
                                                                ...
                                                                <form name="frm1" method="post" name="frm1" action="<%= request.getContextPath() %>/phChangePwdController" onsubmit="return validate()">
                                                                <div class="form">
								<p>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="<%= request.getContextPath() %>/phViewProfileController" class="add-button"><span>Change Profile</span></a>
						<div class="cl">&nbsp;</div>
